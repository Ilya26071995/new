...
// TODO: Переменную нужно использовать в компоненте и это должен быть массив строк
const Text = [
  {
  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.cont}>
        {/*
          TODO:
          Чтобы учитывались переносы, можно использовать в моке <br />
          А в теге <p className={s.text} dangerouslySetInnerHTML={{ __html: text }}>
         */}
        <p className={s.text}>
          Требования к внутренней отделке медицинских учреждений изложены в главе <br />
          ...
          <br /> и противопожарным нормативами, а также подтверждаться соответствующими сертификатами.
          <br />
          <br />
          ...
          <br />
          <br />В соответствии с требованиями к отделке медицинских учреждений (п.4.2),
          <br /> продукция ООО «ТД Интерпан» имеет гладкую, антистатическую и без трещин
          <br /> поверхность, которая выдерживает частые уборки с использованием средств
